        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="row">
                <h5>Trưởng khoa dược</h5>
                <h6>Người nhập kho</h6>
              </div>
            </div>
          </div>
        </body>
                ...
                <Row gutter={16}>
                  <Col span={4.5}>
                    <Form.Item
                      ...
                      // name={`produceBatchNumber_${section.key}`}
                    >
                      <Input
                        onChange={(e) =>
                  ...
                  <Col span={3}>
                    <Form.Item
                      label="Đơn giá"
                      // name={`price_${section.key}`}
                    >
                      <InputNumber
                        onChange={(e) => handleChange(section.key, "price", e)}
                      />
                    </Form.Item>
                  </Col>
                  <Col span={4}>
